...
const tests = [
    ...
    {
        name:
            '[gru] DataError is expected if the rank of input is not 3',
    ...
    {
        name:
            '[gru] DataError is expected if the input.dimensions[0] is not equal to steps',
    ...
    {
        name:
            '[gru] DataError is expected if the rank of recurrentWeight is not 3',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the recurrentWeight.dimensions is invalid',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the rank of options.bias is not 2',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the options.bias.dimensions is invalid',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the rank of options.initialHiddenState is not 3',
        input: { dataType: 'float16', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float16',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the options.initialHiddenState is invalid',
        input: { dataType: 'float16', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float16',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
